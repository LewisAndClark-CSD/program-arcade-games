...
fall apart if you happen to move past it.', 4, 1, None, None]
...
food was placed on the table.', 5, 2, None, 0]
...
basement, you feel like you will never find your way back \
out.', None, None, None, 1]

balcony = ['', None, 4, None, None]
